            ...
            <div className="bg-white">
                <header className="absolute inset-x-0 top-0 z-50">
                    ...
                    >
                        ...
                        <div className="justify-start flex-1 hidden lg:flex lg:gap-x-20">
                            {navigation.map((item) => (
                                <a
                                    key={item.name}
                                    href={item.href}
                    ...
                    <div className="max-w-2xl py-32 mx-auto sm:py-48 lg:py-56">
                        <div className="text-center">
                            ...
                            <p className="mt-6 text-lg leading-8 text-gray-700">
                                ...
                                IGNOU MCA Datesheet for personal use. But you
                                can use it for reference too if you're already
                                here :)
                            </p>
                            <br />
                            <p className="mt-6 text-sm leading-8 text-gray-500">
                                * This is not an official IGNOU website. IGNOU logo is property of IGNOU.
                            </p>
